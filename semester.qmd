...
On Mac (as you correctly described):
...
## Alternative:
You can also use the `=LINEST()` function directly if you want to perform a simple linear regression without using the Data Analysis tool.
